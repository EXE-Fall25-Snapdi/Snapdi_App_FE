...
class BookingCancelledScheduleScreen extends StatefulWidget {
  const BookingCancelledScheduleScreen({super.key});

  @override
  State<BookingCancelledScheduleScreen> createState() =>
      _BookingCancelledScheduleScreenState();
}

class _BookingCancelledScheduleScreenState
    extends State<BookingCancelledScheduleScreen> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Có vẻ như Photographer có việc bận mất rồi.\nBạn hãy thử đặt lịch hẹn mới sau nhé!',
            style: TextStyle(
